package com.fiap.hospital.history.support;
...
public final class JwtTestSupport {
    ...
    public static String issueExpiredToken(
        ...
        Date now = new Date();
        Date issueTime = new Date(now.getTime() - 10 * 60_000L);
    ...
    public static String issueTokenWithClaims(
        RSAKey signingKey,
        UUID subject,
        String role,
        String issuer,
